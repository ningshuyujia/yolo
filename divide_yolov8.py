...
if __name__ == '__main__':
    ...
    parser.add_argument('--image-dir', type=str, default='E:/fj/ultralytics-main/datasets_5.13/images/valaugmented_images',
                        help='image path dir')
    parser.add_argument('--txt-dir', type=str, default='E:/fj/ultralytics-main/dispose_yolov8/5.14/txt',
                        help='txt path dir')
    parser.add_argument('--save-dir', default='E:/fj/ultralytics-main/datasets_5.14', type=str,
                        help='save dir')
